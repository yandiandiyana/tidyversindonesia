...
``` r
grafik_geometrik_histogram(mapping = NULL, bins = NULL, ...)
```
...
#> Error in ggplot2::geom_histogram(mapping = mapping, bins = bins, ...): Problem while computing aesthetics.
