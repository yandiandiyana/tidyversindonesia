# Menentukan pemetaan grafik_estetika visualisasi

Fungsi terjemahan \`ggplot2::aes()\`
...
- ...:
  ...
  Pemetaan grafik_estetika seperti \`x\`, \`y\`, \`color\`, \`shape\`,
  dan \`size\`

## Value

Objek pemetaan grafik_estetika (\`aes\`)
